...
public class SuccessCreateUser {
    ...
    public SuccessCreateUser(String email, String name, String name1, String hobby, String surname1, String fathername1, String cat, String dog, String parrot, String cavy, String hamster, String squirrel, String phone, String adres, String gender, DateStart date_start, DateUpdated date_updated, Birthday birthday, ArrayList<String> role, DateRegister date_register, String date, String by_user, ArrayList<Company> companies, ArrayList<Task> tasks) {
        this.email = email;
        this.name = name;
        this.name1 = name1;
        this.hobby = hobby;
